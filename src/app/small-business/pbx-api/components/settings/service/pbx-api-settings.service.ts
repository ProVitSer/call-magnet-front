...
import { AddPacConnectionData, PbxApiSettings, UpdatePacConnectionData } from "../models/pbx-api-settings.module.ts";
...
export class PbxApiSettingsService {
  ...
  constructor(    
   ...
   public getPacProgramm(selectedOS: string){
    return this.http.get(`${this.apiUrl}/software-distribution/programm`, {params: { os: selectedOS } , responseType: 'blob' }).subscribe(
        (response: Blob) => {
